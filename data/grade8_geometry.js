const questionsDB = [
    ...
    // ========================================================================
    // תת נושא 6: מעגל ועיגול (היקף ושטח)
    // ========================================================================
    ...
    // --- שאלה 1 ---
    {
        ...
        question: `מהו ההבדל המהותי ביותר בין המושג "מעגל" לבין המושג "עיגול" בגיאומטריה?`,
        options: ["המעגל הוא רק הקו החיצוני המסגר את הצורה, והעיגול הוא השטח הפנימי הכלוא בתוכו", "המעגל מתייחס לשטח, והעיגול מתייחס להיקף", "מעגל הוא צורה תלת-ממדית, ועיגול הוא דו-ממדי", "אין שום הבדל, אלו מילים נרדפות לאותה צורה"],
        correctAnswer: 0,
        hint: "חשבו על טבעת לעומת מטבע. הטבעת חלולה בפנים והיא מדגימה מעגל. המטבע מלא וחלק, והוא מדגים עיגול.",
        solution_steps: [
            { verbal_explanation: "בגיאומטריה קיימת הבחנה מדויקת וחשובה בין שני המושגים.", math_expression: "הגדרות בסיס" },
            { verbal_explanation: "ה'מעגל' מוגדר כאוסף של כל הנקודות במישור הנמצאות במרחק קבוע (רדיוס) מנקודה מסוימת (המרכז). זהו למעשה רק הקו, החישוק החיצוני או ההיקף.", math_expression: "מעגל = קו חיצוני" },
            { verbal_explanation: "ה'עיגול', לעומת זאת, כולל גם את המעגל החיצוני וגם את כל השטח והנקודות שכלואות בתוכו (בתוך גבולות המעגל).", math_expression: "עיגול = שטח פנימי" }
        ],
        final_answer: "המעגל הוא רק הקו החיצוני המסגר את הצורה, והעיגול הוא השטח הפנימי הכלוא בתוכו"
    },
    ...
    // --- שאלה 2 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: `איזה מן המשפטים הבאים מתאר במדויק את הקשר שבין רדיוס המעגל לבין קוטר המעגל?<br><br>
        <svg viewBox="0 0 200 150" style="width:100%; max-width:200px; display:block; margin:10px auto;">
            ...
            <line x1="100" y1="75" x2="160" y2="75" stroke="#10b981" stroke-width="3"/>
            <text x="125" y="65" font-size="12" font-weight="bold" fill="#10b981">רדיוס</text>
            <line x1="60" y1="119" x2="140" y2="31" stroke="#ef4444" stroke-width="2" stroke-dasharray="4,4"/>
            <text x="135" y="45" font-size="10" fill="#ef4444" transform="rotate(-45 135 45)">קוטר</text>
        </svg>`,
        options: ["הקוטר ארוך בדיוק פי שניים מהרדיוס", "הרדיוס ארוך פי שניים מהקוטר", "הקוטר גדול מהרדיוס פי המספר פאי (3.14)", "הם שווים זה לזה"],
        correctAnswer: 0,
        hint: "הרדיוס (מחוג) הוא קטע המחבר את המרכז לקצה. הקוטר עובר מקצה לקצה דרך המרכז. לכן, הקוטר מורכב משני רדיוסים מחוברים.",
        solution_steps: [
            { verbal_explanation: "הרדיוס (מסומן לרוב באות R) מוגדר כקטע ישר המחבר את נקודת מרכז המעגל עם נקודה כלשהי על קו המעגל עצמו.", math_expression: "רדיוס = R" },
            { verbal_explanation: "הקוטר (מסומן לרוב באות D) הוא מיתר שעובר דרך מרכז המעגל, ומחבר שתי נקודות נגדיות על היקפו.", math_expression: "קוטר = D" },
            { verbal_explanation: "מכיוון שהקוטר מתחיל בקצה אחד, מגיע למרכז (מרחק של רדיוס אחד) וממשיך מהמרכז לקצה השני (עוד מרחק של רדיוס), הוא שווה תמיד לפעמיים הרדיוס.", math_expression: "D = 2 × R" }
        ],
        final_answer: "הקוטר ארוך בדיוק פי שניים מהרדיוס"
    },
    ...
    // --- שאלה 3 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "בגיאומטריה, אנו משתמשים המון במספר המיוחד פאי (π). מהו בעצם המספר הזה וכיצד הוא התגלה?",
        options: ["זהו יחס קבוע ותמיד זהה המתקבל מחלוקת ההיקף של כל מעגל שהוא בקוטר שלו", "זהו מספר אקראי שהוחלט עליו כדי להקל על חישובים", "זהו השטח של מעגל שהרדיוס שלו שווה ל-10", "זהו האורך של רדיוס מיוחד שמצאו היוונים"],
        correctAnswer: 0,
        hint: "אם תיקחו חוט, תקיפו איתו כל צורה מעגלית בעולם (ממטבע ועד כדור הארץ), תמדדו את אורך החוט, ואז תחלקו את האורך הזה ברוחב של המעגל (הקוטר), תקבלו תמיד את אותה תוצאה: 3.14 בקירוב.",
        solution_steps: [
            { verbal_explanation: "מתמטיקאים בעת העתיקה גילו תופעה מדהימה שחוזרת על עצמה בכל המעגלים בעולם, קטנים וגדולים כאחד.", math_expression: "תגלית יחס קבוע" },
            { verbal_explanation: "אם ניקח את האורך החיצוני של המעגל (ההיקף) ונחלק אותו באורך הקו החוצה אותו באמצע (הקוטר), התוצאה תמיד תהיה מספר קבוע שאינו משתנה לעולם.", math_expression: "היקף / קוטר = קבוע" },
            { verbal_explanation: "למספר הזה, שערכו המקורב הוא 3.14159, קראו בשם האות היוונית פאי (π).", math_expression: "π ≈ 3.14" }
        ],
        final_answer: "זהו יחס קבוע ותמיד זהה המתקבל מחלוקת ההיקף של כל מעגל שהוא בקוטר שלו"
    },
    ...
    // --- שאלה 4 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: `נתון מעגל שאורך הרדיוס שלו הוא 5 סנטימטרים. השתמשו בערך פאי כ-3.14 לצורך החישוב.<br>מהו אורך ההיקף של המעגל הזה?`,
        options: ["31.4 ס\"מ", "15.7 ס\"מ", "78.5 ס\"מ", "314 ס\"מ"],
        correctAnswer: 0,
        hint: "הנוסחה לחישוב היקף מעגל היא פעמיים הרדיוס, כפול פאי (או בקיצור: הקוטר כפול פאי). כלומר: 2 כפול 5 כפול 3.14.",
        solution_steps: [
            { verbal_explanation: "נרשום את הנוסחה המקובלת לחישוב ההיקף של מעגל (מסומן לרוב באות P או C).", math_expression: "היקף = 2 × π × R" },
            { verbal_explanation: "נציב את הנתונים שיש לנו מהשאלה לתוך הנוסחה.", math_expression: "היקף = 2 × 3.14 × 5" },
            { verbal_explanation: "נבצע קודם כפל של המספרים השלמים (שתיים כפול חמש שווה לעשר), כדי להקל על החישוב.", math_expression: "היקף = 10 × 3.14" },
            { verbal_explanation: "הכפלת מספר עשרוני בעשר מזיזה את הנקודה מקום אחד ימינה.", math_expression: "היקף = 31.4" }
        ],
    ...
    // --- שאלה 5 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "נתון מעגל שהקוטר שלו שווה ל-20 סנטימטרים. מהו שטח העיגול החסום במעגל זה? (השאירו את פאי בתשובה, אין צורך להכפיל בו).",
        options: ["100π סמ\"ר", "400π סמ\"ר", "20π סמ\"ר", "40π סמ\"ר"],
        correctAnswer: 0,
        hint: "נוסחת השטח לא משתמשת בקוטר, אלא ברדיוס (רדיוס בריבוע כפול פאי). לכן, חשבו קודם את הרדיוס (מחצית הקוטר). הרדיוס הוא 10. העלו 10 בריבוע.",
        solution_steps: [
            { verbal_explanation: "כדי לחשב את שטח העיגול (מסומן לרוב באות S), אנו זקוקים לרדיוס ולא לקוטר.", math_expression: "שטח = π × R²" },
            { verbal_explanation: "הקוטר הנתון הוא 20. נמצא את הרדיוס על ידי חלוקת הקוטר בשתיים.", math_expression: "R = 20 / 2 = 10" },
            { verbal_explanation: "נציב את הרדיוס שמצאנו בנוסחת השטח.", math_expression: "שטח = π × 10²" },
            { verbal_explanation: "החזקה השנייה של עשר היא מאה. לפי בקשת השאלה, נשאיר את סמל הפאי לצד המספר השלם.", math_expression: "שטח = 100π" }
        ],
        final_answer: "100π סמ\"ר"
    },
    ...
    // --- שאלה 6 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: `לפניכם חצי מעגל. אורך הקוטר של מעגל זה (הבסיס הישר שבתחתית הצורה) הוא 8 סנטימטרים.<br>מהו שטח חצי העיגול? (השאירו פאי בתשובה).<br><br>
        <svg viewBox="0 0 200 120" style="width:100%; max-width:200px; display:block; margin:10px auto;">
            <path d="M 40,100 A 60,60 0 0,1 160,100 Z" fill="#e0f2fe" stroke="#3b82f6" stroke-width="2"/>
            <line x1="40" y1="100" x2="160" y2="100" stroke="#0f172a" stroke-width="2"/>
            <circle cx="100" cy="100" r="3" fill="#0f172a"/>
            <text x="95" y="115" font-size="12" font-weight="bold">8</text>
        </svg>`,
        options: ["8π סמ\"ר", "16π סמ\"ר", "32π סמ\"ר", "4π סמ\"ר"],
        correctAnswer: 0,
        hint: "חשבו תחילה את השטח של עיגול שלם כאילו היה כזה. הרדיוס הוא 4 (חצי מ-8). שטח מעגל שלם הוא פאי כפול 4 בריבוע (שזה 16). מכיוון שזוהי רק מחצית מהצורה, חלקו את התוצאה לשניים.",
        solution_steps: [
            { verbal_explanation: "נמצא את הרדיוס. מכיוון שהקוטר (הקו השלם בתחתית) הוא 8, הרדיוס (מחציתו) הוא 4.", math_expression: "R = 8 / 2 = 4" },
            { verbal_explanation: "נחשב את השטח של עיגול תיאורטי שלם בעל רדיוס זהה, בעזרת נוסחת השטח.", math_expression: "שטח מעגל שלם = π × 4² = 16π" },
            { verbal_explanation: "מכיוון שהצורה הנתונה היא בדיוק חצי מעגל, נחלק את השטח הכולל בשתיים.", math_expression: "שטח חצי מעגל = 16π / 2 = 8π" }
        ],
    ...
    // --- שאלה 7 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "בהמשך לשאלה הקודמת, אם קוטרו של חצי המעגל הוא עדיין 8 ס\"מ. מהו ההיקף השלם של הצורה הזו? (חישבו על גדר שמקיפה את כל הצורה - גם את הקשת המעוגלת וגם את הבסיס הישר).",
        options: ["4π + 8 ס\"מ", "8π + 8 ס\"מ", "4π ס\"מ", "8π ס\"מ"],
        correctAnswer: 0,
        hint: "היקף הצורה מורכב משני חלקים נפרדים. חלק ראשון: הקשת המעוגלת שהיא חצי מהיקף של מעגל שלם (היקף שלם הוא 8 פאי, לכן חצי זה 4 פאי). חלק שני: הקו הישר שסוגר את הצורה (הקוטר) שאורכו 8. חברו אותם ביחד.",
        solution_steps: [
            { verbal_explanation: "נחשב תחילה את ההיקף של מעגל שלם שאורך קוטרו הוא 8. ההיקף הוא הקוטר כפול פאי.", math_expression: "היקף מעגל שלם = 8 × π = 8π" },
            { verbal_explanation: "הקשת המעוגלת שמעל הקוטר היא בדיוק מחצית מההיקף של אותו מעגל שלם.", math_expression: "אורך הקשת (החלק המעוגל) = 8π / 2 = 4π" },
            { verbal_explanation: "כדי למצוא את ההיקף הכללי של הצורה (כל מה שמסגר אותה), חובה להוסיף לקשת המעוגלת גם את הקו הישר שסוגר אותה מלמטה.", math_expression: "תוספת הקו הישר = 8" },
            { verbal_explanation: "ההיקף הכולל הוא החיבור של שניהם יחדיו. (לא ניתן לחבר פאי ומספר שלם לאותו איבר ללא חישוב עשרוני, לכן נשאיר כך).", math_expression: "היקף כולל = 4π + 8" }
        ],
    ...
    // --- שאלה 8 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "היקפו של מעגל גדול הוא 10π סנטימטרים. מהו שטח העיגול הזה?",
        options: ["25π סמ\"ר", "100π סמ\"ר", "50π סמ\"ר", "20π סמ\"ר"],
        correctAnswer: 0,
        hint: "שלב א: מצאו את הרדיוס מתוך נוסחת ההיקף. אם ההיקף (2 כפול R כפול π) שווה 10π, אז 2R שווה 10, כלומר הרדיוס הוא 5. שלב ב: הציבו את הרדיוס 5 בנוסחת השטח (רדיוס בריבוע כפול פאי).",
        solution_steps: [
            { verbal_explanation: "היקף המעגל נתון לנו כ-10π. נרשום את הנוסחה להיקף ונשווה אותה לנתון.", math_expression: "2 × π × R = 10π" },
            { verbal_explanation: "נצמצם את פאי (π) משני צידי המשוואה כיוון שהוא מופיע ככופל.", math_expression: "2 × R = 10" },
            { verbal_explanation: "נחלק ב-2 למציאת הרדיוס התקין.", math_expression: "R = 5" },
            { verbal_explanation: "כעת, נציב את הרדיוס שמצאנו אל תוך נוסחת השטח.", math_expression: "שטח = π × 5² = 25π" }
        ],
    ...
    // --- שאלה 9 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: `בריבוע שצלעו ארוכה 10 ס"מ, חסום מעגל כך שהוא נוגע בדיוק בארבע צלעות הריבוע מבפנים.<br>מהו רדיוס המעגל החסום?<br><br>
        <svg viewBox="0 0 200 150" style="width:100%; max-width:200px; display:block; margin:10px auto;">
            <rect x="50" y="25" width="100" height="100" fill="none" stroke="#0f172a" stroke-width="2"/>
            <circle cx="100" cy="75" r="50" fill="#e0f2fe" stroke="#3b82f6" stroke-width="2"/>
            <text x="90" y="140" font-size="12" font-weight="bold">10</text>
        </svg>`,
        options: ["5 ס\"מ", "10 ס\"מ", "2.5 ס\"מ", "20 ס\"מ"],
        correctAnswer: 0,
        hint: "שימו לב היטב לשרטוט. המעגל מתוח מקצה לקצה בתוך הריבוע. לכן, הקוטר השלם של המעגל (הרוחב הכללי שלו) שווה בדיוק לאורך צלע הריבוע (שהוא 10). הרדיוס הוא חצי מקוטר.",
        solution_steps: [
            { verbal_explanation: "כאשר מעגל חסום בריבוע ונוגע בצלעותיו המקבילות, הרוחב המקסימלי של המעגל תואם בדיוק למרחק שבין שתי צלעות הריבוע.", math_expression: "" },
            { verbal_explanation: "המרחק המקסימלי במעגל (מקצה אחד לקצה השני דרך המרכז) הוא קוטר המעגל. המרחק בין שתי צלעות ריבוע הוא אורך צלע הריבוע.", math_expression: "קוטר המעגל = צלע הריבוע = 10" },
            { verbal_explanation: "הרדיוס הוא תמיד מחצית מן הקוטר. נחלק את הקוטר בשתיים.", math_expression: "רדיוס = 10 / 2 = 5" }
        ],
        final_answer: "5 ס\"מ"
    },
    ...
    // --- שאלה 10 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "שטחו של מעגל גדול מסוים שווה ל-36π סמ\"ר. מהו ההיקף של המעגל הזה?",
        options: ["12π ס\"מ", "6π ס\"מ", "18π ס\"מ", "72π ס\"מ"],
        correctAnswer: 0,
        hint: "זוהי פעולה הפוכה. אם השטח (רדיוס בריבוע כפול פאי) שווה ל-36 פאי, סימן שהרדיוס בריבוע שווה ל-36. מהו הרדיוס? (השורש של 36 הוא 6). כעת הציבו רדיוס של 6 בנוסחת ההיקף (פעמיים רדיוס כפול פאי).",
        solution_steps: [
            { verbal_explanation: "נשתמש בנוסחת השטח להרכבת משוואה שמשווה את הנתון הידוע.", math_expression: "π × R² = 36π" },
            { verbal_explanation: "נצמצם את הפאי (π) משני האגפים. נישאר עם רדיוס בריבוע ששווה ל-36.", math_expression: "R² = 36" },
            { verbal_explanation: "נוציא שורש ריבועי כדי למצוא את הרדיוס העצמאי (ניקח את הערך החיובי כי אורך חייב להיות חיובי).", math_expression: "R = 6" },
            { verbal_explanation: "נציב את הרדיוס בנוסחה הסטנדרטית לחישוב ההיקף (קוטר כפול פאי, או פעמיים רדיוס כפול פאי).", math_expression: "היקף = 2 × π × 6 = 12π" }
        ],
        final_answer: "12π ס\"מ"
    },
    ...
    // --- שאלה 11 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "גלגל של אופניים משלים סיבוב אחד מלא (הקפה אחת שלמה) כאשר הוא מתגלגל על כביש. אם רדיוס הגלגל הוא 30 סנטימטרים, מהו המרחק שעוברים האופניים בסיבוב יחיד כזה? (חשבו עם π=3.14).",
        options: ["188.4 ס\"מ", "94.2 ס\"מ", "2826 ס\"מ", "60 ס\"מ"],
        correctAnswer: 0,
        hint: "מרחק של סיבוב אחד מלא של גלגל שווה בדיוק לאורך ההיקף החיצוני של הגלגל. חשבו את ההיקף של המעגל (פעמיים פאי כפול רדיוס).",
        solution_steps: [
            { verbal_explanation: "כאשר גלגל משלים סיבוב יחיד על הקרקע, כל נקודה על המעטפת שלו נוגעת ברצפה. המרחק הכולל שנפרש שווה במדויק לאורך ההיקף של הגלגל.", math_expression: "מרחק סיבוב = היקף מעגל" },
            { verbal_explanation: "נשתמש בנוסחת ההיקף למעגל, תוך הצבת הרדיוס הנתון.", math_expression: "היקף = 2 × π × 30" },
            { verbal_explanation: "נכפיל את המספרים השלמים לקבלת הקוטר שהוא 60, ונציב את הערך המקורב של פאי שסופק.", math_expression: "היקף = 60 × 3.14" },
            { verbal_explanation: "נבצע את הכפל בעזרת מחשבון. שישים כפול שלוש הם מאה ושמונים. התוספת העשרונית היא שמונה נקודה ארבע.", math_expression: "188.4" }
        ],
        final_answer: "188.4 ס\"מ"
    },
    ...
    // --- שאלה 12 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "צורה מורכבת מריבוע שאורך צלעו הוא 6 ס\"מ, ועליו הודבק 'כובע' שהוא חצי מעגל. קוטר חצי המעגל מתלכד לחלוטין עם הצלע העליונה של הריבוע. מהו השטח הכולל של כל הצורה המורכבת? (השאירו פאי בתשובה).",
        options: ["36 + 4.5π סמ\"ר", "36 + 9π סמ\"ר", "36 + 18π סמ\"ר", "24 + 9π סמ\"ר"],
        correctAnswer: 0,
        hint: "פצלו את הבעיה לשני שטחים. שטח הריבוע הוא 36 (6 כפול 6). רדיוס חצי המעגל הוא 3 (כי הקוטר הוא 6, בהתאם לצלע הריבוע שעליה הוא יושב). שטח מעגל שלם של רדיוס 3 הוא 9π. מחצית ממנו היא 4.5π.",
        solution_steps: [
            { verbal_explanation: "נחשב את השטח של הריבוע העומד בבסיס הצורה.", math_expression: "שטח ריבוע = צלע × צלע = 6 × 6 = 36" },
            { verbal_explanation: "הקוטר של חצי המעגל מונח על צלע הריבוע, לכן הקוטר שווה 6 ס\"מ. מכאן נסיק שהרדיוס הוא מחצית, דהיינו 3 ס\"מ.", math_expression: "רדיוס = 6 / 2 = 3" },
            { verbal_explanation: "נחשב את שטחו של מעגל שלם בעל רדיוס כזה, ולאחר מכן נחצה אותו לשניים כי יש לנו רק חצי מעגל.", math_expression: "שטח חצי מעגל = (π × 3²) / 2 = 9π / 2 = 4.5π" },
            { verbal_explanation: "השטח הכולל של הצורה הוא סכום השטחים הנפרדים שחישבנו כעת.", math_expression: "שטח כולל = 36 + 4.5π" }
        ],
        final_answer: "36 + 4.5π סמ\"ר"
    },
    ...
    // --- שאלה 13 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "נתון מעגל ברדיוס R. אם נגדיל את רדיוס המעגל הזה בדיוק פי 2. בכמה יגדל **שטח** העיגול החדש לעומת הישן?",
        options: ["הוא יגדל פי 4 (ריבוע ההגדלה)", "הוא יגדל פי 2", "הוא יגדל פי π (פאי)", "הוא לא ישתנה"],
        correctAnswer: 0,
        hint: "בנוסחת השטח, הרדיוס מועלה בריבוע (R²). לכן, כל הגדלה של הרדיוס משפיעה על השטח באופן 'ריבועי'. אם הרדיוס מוכפל פי 2, ההשפעה על השטח היא 2 בריבוע, כלומר פי 4.",
        solution_steps: [
            { verbal_explanation: "נרשום את הנוסחה הכללית המקורית לשטח.", math_expression: "שטח מקורי = π × R²" },
            { verbal_explanation: "נרכיב את הנוסחה עבור מעגל שבו הרדיוס הוכפל פי שתיים. שימו לב: ה-2 הוא חלק מהרדיוס החדש ומועלה גם הוא בריבוע בתוך הסוגריים.", math_expression: "שטח חדש = π × (2R)²" },
            { verbal_explanation: "נפתח את הסוגריים לפי חוקי החזקות (גם ה-2 עולה בריבוע והופך ל-4).", math_expression: "שטח חדש = π × 4 × R²" },
            { verbal_explanation: "נשווה בין השטח החדש לישן, ונראה שהתווסף כופל מרכזי של 4. מכאן שהשטח גדל פי ארבעה.", math_expression: "שטח חדש = 4 × (שטח מקורי)" }
        ],
        final_answer: "הוא יגדל פי 4 (ריבוע ההגדלה)"
    },
    ...
    // --- שאלה 14 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: "בהמשך לשאלה הקודמת: אם הגדלנו את רדיוס המעגל פי 2, בכמה יגדל **היקף** המעגל החדש לעומת הישן?",
        options: ["הוא יגדל בדיוק פי 2", "הוא יגדל פי 4", "הוא יגדל ב-2 סנטימטרים", "הוא לא ישתנה"],
        correctAnswer: 0,
        hint: "בניגוד לשטח שבו הרדיוס מועלה בריבוע, בנוסחת ההיקף (2 כפול פאי כפול רדיוס) הרדיוס הוא ללא חזקה. לכן היחס נשמר: הגדלת הרדיוס פי מספר כלשהו, מגדילה את ההיקף בדיוק באותו מספר.",
        solution_steps: [
            { verbal_explanation: "נרשום את הנוסחה הכללית להיקף מעגל.", math_expression: "היקף מקורי = 2 × π × R" },
            { verbal_explanation: "נציב את הרדיוס החדש (שהוא 2R) במקום ה-R המקורי.", math_expression: "היקף חדש = 2 × π × (2R)" },
            { verbal_explanation: "לפי חוק החילוף של הכפל, ניתן להוציא את הכופל 2 החוצה לראש המשוואה ולראות את ההיקף המקורי בתוכו.", math_expression: "היקף חדש = 2 × (2 × π × R)" },
            { verbal_explanation: "ניתן לראות בבירור שההיקף החדש הוא פשוט פעמיים ההיקף הישן. היחס נשמר ישירות.", math_expression: "היקף חדש = 2 × (היקף מקורי)" }
        ],
        final_answer: "הוא יגדל בדיוק פי 2"
    },
    ...
    // --- שאלה 15 ---
    {
        ...
        topic: "גאומטריה",
        subTopic: "מעגל ועיגול (היקף ושטח)",
        question: `צורת טבעת (המכונה 'טבעת מעגלית' או Annulus) נוצרת על ידי שני מעגלים בעלי מרכז משותף. רדיוס המעגל החיצוני והגדול הוא 10 ס"מ, ורדיוס המעגל הפנימי (החור) הוא 6 ס"מ.<br>מהו השטח של הטבעת בלבד (האזור שבין שני המעגלים)?<br><br>
        <svg viewBox="0 0 200 200" style="width:100%; max-width:200px; display:block; margin:10px auto;">
            <circle cx="100" cy="100" r="80" fill="#cbd5e1" stroke="#475569" stroke-width="2"/>
            <circle cx="100" cy="100" r="40" fill="#ffffff" stroke="#475569" stroke-width="2"/>
            <circle cx="100" cy="100" r="4" fill="#0f172a"/>
            <line x1="100" y1="100" x2="100" y2="20" stroke="#0f172a" stroke-width="2"/>
            <text x="105" y="55" font-size="12" font-weight="bold">10</text>
            <line x1="100" y1="100" x2="140" y2="100" stroke="#ef4444" stroke-width="2"/>
            <text x="115" y="95" font-size="12" font-weight="bold" fill="#ef4444">6</text>
        </svg>`,
        options: ["64π סמ\"ר", "100π סמ\"ר", "36π סמ\"ר", "16π סמ\"ר"],
        correctAnswer: 0,
        hint: "כדי למצוא את שטח הטבעת, עלינו לחשב את השטח של המעגל הגדול השלם, ולחסר ממנו (לגזור החוצה) את השטח של המעגל הפנימי הלבן והחלול. כלומר: (10 בריבוע כפול פאי) פחות (6 בריבוע כפול פאי).",
        solution_steps: [
            { verbal_explanation: "נחשב תחילה את כל השטח של המעגל הגדול כאילו היה מלא. הרדיוס שלו הוא 10.", math_expression: "שטח גדול = π × 10² = 100π" },
            { verbal_explanation: "נחשב את השטח של ה'חור' הלבן והריק במרכז (המעגל הקטן). הרדיוס שלו הוא 6.", math_expression: "שטח חלל = π × 6² = 36π" },
            { verbal_explanation: "כדי למצוא את שטח הטבעת המלאה בלבד, נפחית את החלל מתוך העיגול השלם.", math_expression: "שטח טבעת = 100π - 36π = 64π" }
        ],
        final_answer: "64π סמ\"ר"
    }
];